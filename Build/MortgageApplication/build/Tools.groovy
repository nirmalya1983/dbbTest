...
def createDatasets() {
    def properties = BuildProperties.getInstance()
	def srcOptions = "cyl space(1,1) lrecl(80) dsorg(PO) recfm(F,B) dsntype(library) msg(1) volser(VPWRKI)"
	def loadOptions = "cyl space(1,1) dsorg(PO) recfm(U) blksize(32760) dsntype(library) msg(1) volser(VPWRKI)"
